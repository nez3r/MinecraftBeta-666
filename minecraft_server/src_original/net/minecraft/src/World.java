...
public class World implements IBlockAccess {
	...
	protected IChunkProvider func_22086_b() {
		...
		return new ChunkProvider(this, var1, this.worldProvider.func_2938281_a());
	}
	...
	public boolean isBlockOpaqueCube(int var1, int var2, int var3) {
		Block var4 = Block.blocksList[this.getBlockId(var1, var2, var3)];
		return var4 == null ? false : var4.blockMaterial.func_28128_h() && var4.func_28025_b();
	}
	...
	protected void doRandomUpdateTicks() {
		...
		while(var12.hasNext()) {
			...
			if(this.ambientTickCountdown == 0) {
				...
				var7 += var3;
				var8 += var4;
				if(var10 == 0 && this.func_28098_j(var7, var9, var8) <= this.rand.nextInt(8) && this.getSavedLightValue(EnumSkyBlock.Sky, var7, var9, var8) <= 0) {
