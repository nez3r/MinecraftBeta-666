...
public class ItemPickaxeAll extends ItemTool {
	private static Block[] blocksEffectiveAgainst = new Block[]{
		...
		Block.blockDiamond, Block.ice, Block.bloodStone, Block.oreLapis,
	...
	@Override
	public boolean func_25007_a(ItemStack itemStack, int blockId, int x, int y, int z, EntityLiving entity) {
		// Не получает урон
		return true;
	}
}
