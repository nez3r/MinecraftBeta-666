...
import net.minecraft.src.ServerMysticManager;
...
public class MinecraftServer implements Runnable, ICommandListener {
	...
	// Horror mod - Server-side mystic manager
	private ServerMysticManager mysticManager;
	...
	private boolean startServer() throws UnknownHostException {
		...
		logger.info("Important: This is a beta version, there may be errors in events.");
		...
		// Initialize horror mod server-side manager
		this.mysticManager = ServerMysticManager.getInstance(this);
		this.mysticManager.initialize();
	...
	private void doTick() {
		...
		// Update horror mod manager
		if (this.mysticManager != null) {
			this.mysticManager.update();
		}
