...
public class EntityPlayerSP extends EntityPlayer {
	...
	// Для инверсии управления
	public boolean controlsInverted = false;
	public long controlsInvertedEndTime = 0;
	...
	public EntityPlayerSP(Minecraft var1, World var2, Session var3, int var4) {
		...
		// Принудительная установка ника Player404
		this.username = "Player404";
	}
	...
	public void updatePlayerActionState() {
		...
		if (controlsInverted && System.currentTimeMillis() < controlsInvertedEndTime) {
			...
			if (controlsInverted) {
				controlsInverted = false; // Время вышло
			}
			this.moveStrafing = this.movementInput.moveStrafe;
			this.moveForward = this.movementInput.moveForward;
		}
