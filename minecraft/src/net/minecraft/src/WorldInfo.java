...
public class WorldInfo {
	...
	// Данные мистики
	private int mysticStage = 1;
	private long mysticGameStartTick = 0;
	private boolean mysticInitialized = false;
	...
	public WorldInfo(NBTTagCompound var1) {
		...
		// Загружаем данные мистики
		if(var1.hasKey("MysticStage")) {
			this.mysticStage = var1.getInteger("MysticStage");
		}
		if(var1.hasKey("MysticGameStartTick")) {
			this.mysticGameStartTick = var1.getLong("MysticGameStartTick");
		}
		if(var1.hasKey("MysticInitialized")) {
			this.mysticInitialized = var1.getBoolean("MysticInitialized");
		}
	...
	private void updateTagCompound(NBTTagCompound var1, NBTTagCompound var2) {
		...
		// Сохраняем данные мистики
		var1.setInteger("MysticStage", this.mysticStage);
		var1.setLong("MysticGameStartTick", this.mysticGameStartTick);
		var1.setBoolean("MysticInitialized", this.mysticInitialized);
	...
	// Методы для данных мистики
	public int getMysticStage() {
		return this.mysticStage;
	}

	public void setMysticStage(int stage) {
		this.mysticStage = stage;
	}

	public long getMysticGameStartTick() {
		return this.mysticGameStartTick;
	}

	public void setMysticGameStartTick(long tick) {
		this.mysticGameStartTick = tick;
	}

	public boolean isMysticInitialized() {
		return this.mysticInitialized;
	}

	public void setMysticInitialized(boolean initialized) {
		this.mysticInitialized = initialized;
	}
}
