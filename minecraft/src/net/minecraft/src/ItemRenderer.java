...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float var1) {
		...
		if (manager.isHandDecayActive) {
			float decayAmount = (float)Math.sin(System.currentTimeMillis() / 200.0) * 0.3f + 0.5f;
			GL11.glColor4f(var5 * decayAmount, var5 * decayAmount * 0.5f, var5 * decayAmount * 0.5f, 0.8f);
		} else {
