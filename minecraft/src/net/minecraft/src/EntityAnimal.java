...
public abstract class EntityAnimal extends EntityCreature {
	...
	// Переопределяем attackEntityFrom для мирных мобов
	public boolean attackEntityFrom(Entity var1, int var2) {
		boolean result = super.attackEntityFrom(var1, var2);

		// Если ударил игрок, моб становится агрессивным на 10 секунд
		if(var1 instanceof EntityPlayer && result) {
			MysticManager.getInstance().makeAggressiveTemporarily(this);
		}
