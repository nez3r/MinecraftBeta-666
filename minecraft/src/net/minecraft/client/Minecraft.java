...
import net.minecraft.src.MysticManager;
...
public abstract class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		// Инициализация MysticManager
		MysticManager.getInstance().init(this);
	...
	public void runTick() {
		...
		// Обновление MysticManager
		MysticManager.getInstance().update();
									...
									while(true) {
										...
										if(Keyboard.getEventKey() == Keyboard.KEY_F11) {
											...
											if(this.currentScreen != null) {
												...
												// Чат доступен всегда (и в одиночной игре)
